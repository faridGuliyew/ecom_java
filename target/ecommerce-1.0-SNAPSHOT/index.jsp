...
<div class="site-wrap">
        ...
        <div class="container" style="position: relative; z-index: 2; text-align: center;">
            <div class="row align-items-center justify-content-center h-100">
                <div class="col-md-8">
                    ...
                    <p class="lead text-light mb-4">Discover the latest trends and exclusive offers only on FaridCommerce!</p>
    ...
    <div class="collections-section py-5 bg-light">
        <div class="container text-center">
            <h2 class="h1 font-weight-bold">Shop Our Collections</h2>
            <p class="mb-5">Curated just for you, find what you love.</p>
            <div class="row">
